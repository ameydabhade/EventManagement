...
export default function SigninPage() {
  ...
  const handleSubmit = (e) => {
    ...
    // Add backend API call for login here
  }

  const handleGuestLogin = (e) => {
    e.preventDefault()
    console.log('Logging in as guest')
    // Handle guest login logic here (e.g., bypass form validation, etc.)
  }
      ...
      <div className="w-full max-w-md p-8 space-y-8 rounded-xl shadow-2xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className='gap-2 flex flex-col'>
            ...
            <button
              type="submit"
              onSubmit={} // Prevent form submission and trigger guest login logic
        ...
        <div className="text-center">
          <p className="text-sm text-gray-400">
            ...
            <Link to="../signup" className="font-medium text-[#7a56d6] hover:text-[#fa4d56] transition duration-150 ease-in-out">
              Sign up
            </Link>
          </p>
        </div>
